        ...
        <div className="w-screen h-screen flex justify-center items-center">
            ...
            <div className="shadow-2xl p-[40px] bg-pallete02 relative flex flex-col gap-[40px]">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="bg-pallete01 w-[20%] flex flex-col justify-center items-center p-[15px] rounded-t-[15px]">
                        <strong className="text-white text-[25px]">Result:</strong>
                        <p className="bg-white rounded-[35px] p-[8px]">{result.toFixed(2)}</p>
                    </div>
